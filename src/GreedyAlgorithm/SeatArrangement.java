...
public class SeatArrangement {
    public static void main(String[] args) {
        System.out.println(minHop("....x....xx...x.."));
    }
    static int minHop(String A){
        ...
        int k=1;
        while(left>=0){
            res += occupied.get(mid)-occupied.get(left)-k;
            left--;k++;
        }
        k=1;
        while(right<occupied.size()){
            res += occupied.get(right)-occupied.get(mid)-k;
            right++;k++;
        }
        return res;
    }
